...
Rundoc.configure do |config|
  config.project_root = "jsonp-wrapper"
  config.filter_sensitive(email => "developer@example.com")
end
```
<!--
  rundoc src:
  https://github.com/heroku/jsonp-wrapper/blob/master/jsonp-wrapper.md

  Command:
  $ rundoc build --path jsonp-wrapper.md
-->
...
```term
:::>- $ git clone https://github.com/heroku/jsonp-wrapper.git
:::>- $ cd jsonp-wrapper
```
...
The demo app you deployed already has a `build.gradle` ([see it here](https://github.com/heroku/jsonp-wrapper/blob/master/build.gradle)). Here's an excerpt:
...
[Here's the final source code](https://github.com/heroku/jsonp-wrapper/blob/localchanges/src/main/java/com/example/heroku/HerokuApplication.java) for `HerokuApplication.java` - yours should look similar.  [Here's a diff](https://github.com/heroku/jsonp-wrapper/compare/localchanges) of all the local changes you should have made.
